...
class QTFINCHARTS_EXPORT BaselineSeries : public ChartSeries {
    Q_OBJECT
    QML_ELEMENT
    ...
    Q_PROPERTY(QColor topFillColor1 READ topFillColor1 WRITE setTopFillColor1 NOTIFY optionsChanged)
    Q_PROPERTY(QColor topFillColor2 READ topFillColor2 WRITE setTopFillColor2 NOTIFY optionsChanged)
    Q_PROPERTY(QColor topLineColor READ topLineColor WRITE setTopLineColor NOTIFY optionsChanged)
    Q_PROPERTY(QColor bottomFillColor1 READ bottomFillColor1 WRITE setBottomFillColor1 NOTIFY optionsChanged)
    Q_PROPERTY(QColor bottomFillColor2 READ bottomFillColor2 WRITE setBottomFillColor2 NOTIFY optionsChanged)
    Q_PROPERTY(QColor bottomLineColor READ bottomLineColor WRITE setBottomLineColor NOTIFY optionsChanged)
...
public:
    explicit BaselineSeries(QObject* parent = nullptr);
    ...
    [[nodiscard]] QColor topFillColor1() const noexcept { return m_topFillColor1; }
    void setTopFillColor1(const QColor& color);

    [[nodiscard]] QColor topFillColor2() const noexcept { return m_topFillColor2; }
    void setTopFillColor2(const QColor& color);

    [[nodiscard]] QColor topLineColor() const noexcept { return m_topLineColor; }
    void setTopLineColor(const QColor& color);

    [[nodiscard]] QColor bottomFillColor1() const noexcept { return m_bottomFillColor1; }
    void setBottomFillColor1(const QColor& color);

    [[nodiscard]] QColor bottomFillColor2() const noexcept { return m_bottomFillColor2; }
    void setBottomFillColor2(const QColor& color);

    [[nodiscard]] QColor bottomLineColor() const noexcept { return m_bottomLineColor; }
    void setBottomLineColor(const QColor& color);
...
private:
    ...
    QColor m_topFillColor1 = QColor(38, 166, 154, 71);
    QColor m_topFillColor2 = QColor(38, 166, 154, 13);
    QColor m_topLineColor = QColor("#26a69a");
    QColor m_bottomFillColor1 = QColor(239, 83, 80, 13);
    QColor m_bottomFillColor2 = QColor(239, 83, 80, 71);
    QColor m_bottomLineColor = QColor("#ef5350");
